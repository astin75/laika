        ...
        <div className="elements">
            <ul>
                <li>
                    ...
                    <label htmlFor="rect"><i className="icon icon-rectangle"></i> Rect <span
                        className="arrow icon-arrow-down"></span></label>
                ...
                <li>
                    ...
                    <label htmlFor="point"><i className="icon icon-point"></i> Point <span
                        className="arrow icon-arrow-down"></span></label>
                ...
                <li>
                    ...
                    <label htmlFor="line"><i className="icon icon-line"></i> Line <span
                        className="arrow icon-arrow-down"></span></label>
                    <div className="element-list">
                        <ul>
                            <li>
                ...
                <li>
                    ...
                    <label htmlFor="polygon"><i className="icon icon-polygon"></i> Polygon <span
                        className="arrow icon-arrow-down"></span></label>
                    <div className="element-list">
                        <ul>
                            <li>
