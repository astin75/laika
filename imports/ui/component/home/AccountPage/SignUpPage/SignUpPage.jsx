    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.textForm}>
                    ...
                    <Text align="right" className={styles.signUpLink} color={"blue"}  highlight={['회원가입']} onClick={() => {
                        setIsThereAccount(true);
                    }} size="xs"> 로그인</Text >
                <Text size="xs"  align="right">페이지지로 돌아가기.</Text>
           </div>
            <TextInput
                error={errUser}
                placeholder="ID"
            ...
            <Button className={styles.command} onClick={signUpProcess}>회원가입</Button>
        </div>
    );
}
